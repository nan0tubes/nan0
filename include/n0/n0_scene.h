...
class n0Scene : public IUpdateable, public IDrawable,  public IEventHandler<32>, public IEventListener
{
...
//	virtual bool OnEvent(const irr::SEvent& event) { return false;}
	virtual bool OnEvent(n0Event *e) { return kFalse; }
